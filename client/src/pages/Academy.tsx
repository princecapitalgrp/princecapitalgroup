...
const ACADEMY_BG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663478715478/3WDgnQTEJ6CYmFhbjFiUW8/pcg-academy-bg-SiZWbmuevCpcAsjAwJ5uNx.webp";
...
const riskToolkit = [
  {
    ...
    description:
      "Structured template for post-trade journaling. Includes sections for setup anatomy, execution quality, and psychological factors.",
  ...
  },
  {
    ...
    description:
      "Eight-point checklist to verify all confluence gates before entry. Ensures discipline and removes discretion.",
  ...
  },
  {
    ...
    description:
      "Framework for weekly process review. Tracks adherence, setup quality, and continuous improvement metrics.",
...
const learningPaths = [
  {
    level: "Foundations",
    description:
      "Start here. Learn the basics of market structure, session timing, and liquidity concepts.",
    modules: 4,
  },
  {
    level: "Intermediate",
    description:
      "Dive deeper into z-score analysis, cross-pair relationships, and macro filtering.",
    modules: 6,
  },
  {
    level: "Advanced",
    description:
      "Master confluence gating, position sizing, and psychological discipline in live trading.",
    modules: 5,
  },
];
...
export default function Academy() {
  useSEO({
    ...
    description:
      "Educational resources for FX traders: weekly process memos, setup anatomy library, risk toolkit, and learning paths. Educational content only.",
    ...
    <div ref={pageRef}>
      ...
      >
        ...
        <div className="relative container">
          ...
          >
            Public educational resources documenting our research-to-execution
            process. Learn our approach to signal stacking, risk governance, and
            ...
            {setupLibrary.map(setup => (
              <div key={setup.id} className="fade-up">
                <button
                  onClick={() =>
                    setExpandedSetup(
                      expandedSetup === setup.id ? null : setup.id
                    )
                  }
                  className="w-full p-6 rounded-lg text-left transition-all duration-300"
                  style={{
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                >
                  Join periodic office hours to discuss process, ask questions
                  about the signal stack, and engage with the PCG community.
                  Topics include confluence gating, z-score analysis, risk
